...
// Define the recordAttempt structure, with 4 properties.  Structure tags are used by encoding/json library
...
func (s *SmartContract) createRecord(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var recordAttempt = RecordAttempt{SensorID: args[1], Date: args[2], Value: args[3], DataID: args[4]}

	recordAsBytes, _ := json.Marshal(recordAttempt)
